...
- Sanity checks: counts + summary statistics and histogram of happiness score + histogram of happiness score by sentiment to ensure the sample reflects the dataset's distributions
